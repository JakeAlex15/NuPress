      ...
      <div className= "container py-5"> 
            ...
            <div className= "row">
                <div className= "col-10 mx-auto col-md-6 my-3 text-capitalize">
                    <img src= "img/SKC.jpg" width="200" className= "img-fluid" alt= "SKC Image" />
                </div>
                <div className= "col-10 mx-auto col-md-6 my-3 text-capitalize">
                ...
                <Row>
                  ...
                  <Col sm="6">
                    <Card body>
                      ...
                      <CardText>Meet Stephen King, as he goes into depth about his life and inspritations</CardText>
